...
<<<<<<< HEAD:scripts/figuresAndTables/fig6_gsea.R
...
=======
path <- "data/gsea/COVID-19 GSEA"
resultsPath <- paste0(path, "/data/gsea")
>>>>>>> e4eb264 (Update local repo: delete old files, add new ones):scripts/figures/fig6_gsea.R
setwd(resultsPath)
