...
conds <- c("SuppO2_Binom", "Neuts_Binom", "D614GNeutralization")
...
labelDist <- list(Neuts_Binom = 0.15,
                  D614GNeutralization = 0.07,
                  SuppO2_Binom = 0.09,
                  Spike.D614G_tp2_Binom = 0.065)

labelPos <- list(Neuts_Binom = 45,
                 D614GNeutralization = 180,
                 SuppO2_Binom = 330,
...
fileName <- paste0("../../../figuresAndTables/fig5/fig5B_venn_", conds[1], "_", conds[2], "_", dateTag, ".png")
...
## Conditions to compare
conds <- c("D614GNeutralization", "Spike.D614G_tp2_Binom")
...
## Color and label setup
fillColors <- unlist(colorLookup[conds])
categoryLabels <- c(labelLookup[[conds[1]]], labelLookup[[conds[2]]])

## Customize label position and distance between conditions
labelDist <- list(Neuts_Binom = list(D614GNeutralization = c(0.07, 0.1),
                                       SuppO2_Binom = c(0.08, 0.07),
                                       Spike.D614G_tp2_Binom = c(0.08, 0.11)),
                    D614GNeutralization = list(SuppO2_Binom = c(0.08, 0.06),
                                               Spike.D614G_tp2_Binom = c(0.08, 0.1)),
                    SuppO2_Binom = list(D614GNeutralization = c(0.06, 0.07),
                                        Neuts_Binom = c(0.06, 0.07),
                                        Spike.D614G_tp2_Binom = c(0.1, 0.07)),
                    Spike.D614G_tp2_Binom = list(D614GNeutralization = c(0.06, 0.07),
                                                 Neuts_Binom = c(0.15, 0.07),
                                                 Spike.D614G_tp2_Binom = c(0.1, 0.07)))

labelPos <- list(Neuts_Binom = list(D614GNeutralization = c(210, 140),
                                      SuppO2_Binom = c(325, 45),
                                    Spike.D614G_tp2_Binom = c(325, 45)),
                   D614GNeutralization = list(SuppO2_Binom = c(325, 40),
                                              Spike.D614G_tp2_Binom = c(325, 50)),
                   SuppO2_Binom = list(D614GNeutralization = c(220, 150),
                                       Neuts_Binom = c(220, 150),
                                       Spike.D614G_tp2_Binom = c(220, 150)),
                   Spike.D614G_tp2_Binom = list(D614GNeutralization = c(230, 150),
                                                Neuts_Binom = c(260, 150)))

## Extract distances and positions based on conditions
dist <- labelDist[[conds[1]]][[conds[2]]]
position <- labelPos[[conds[1]]][[conds[2]]]
